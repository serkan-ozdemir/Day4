...
public class VHVExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(VHVDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new VHVStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static VHVDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static VHVDateTimeConverter dateTimeConverter = new VHVStandardDateTimeConverter();

    public VHVExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public VHVExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new VHVMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=VHVHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,VHVExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=VHVHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
