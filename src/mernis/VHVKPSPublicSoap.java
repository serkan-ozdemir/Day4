...
public class VHVKPSPublicSoap
{
    ...
    public VHVKPSPublicSoap(){}

    public VHVKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public VHVKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        VHVExtendedSoapSerializationEnvelope envelope= new VHVExtendedSoapSerializationEnvelope(VHVExtendedSoapSerializationEnvelope.VER11);
